import { Tag, Calendar, Banknote, ArrowRight, FileCheck, ChevronLeft, ChevronRight } from "lucide-react";
          ...
          {offerList.length > 0 ? (
            <>
              {offerList.map((offer) => (
                ...
                <p className="text-sm text-gray-600">Showing {offerList.length} of {totalCount} results</p>
                <nav className="flex items-center rounded-md shadow-sm">
                  <button 
                    disabled={!offers?.previous}
