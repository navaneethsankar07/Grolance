...
export default function JobCard({ category, title, description, priceRange, duration, skills }) {
  return (
    <div className="bg-white rounded-xl p-8 shadow-sm border border-transparent hover:border-blue-100 transition-all flex flex-col h-full">
      <div className="flex justify-between items-start mb-4">
        ...
        <button className="p-2.5 bg-[#3B82F6] text-white rounded-md hover:bg-blue-600 transition-colors">
