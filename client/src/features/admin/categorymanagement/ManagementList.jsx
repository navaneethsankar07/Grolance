...
export const ManagementList = ({ title, icon: Icon, items, iconColor , onAdd, onEdit, onDelete}) => {
   ...
   return (
    <div className="mb-12">
      <div className="flex items-center justify-between mb-6">
        ...
        {/* The Add Button - unique for each list */}
        <button
          onClick={onAdd}
          className={`flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/30 hover:text-[#000000] transition-colors text-sm font-semibold shadow-sm`}
        >
          <Plus size={18} />
          Add {title.slice(0)}
        </button>
