...
import { useDisputeMutation } from "../../../freelancer/contracts/contractMutation";

export default function ClientDisputeModal({ onClose, contractId }) {
        ...
        <div className="flex items-start gap-3 p-5 sm:px-6 sm:py-5 border-b border-gray-100">
          <div className="flex-1 flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 leading-5 mt-1">Report an issue with this contract as a client for our team to review.</p>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[80vh]">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="poor_quality">Work quality does not match proposal</option>
                <option value="missed_deadline">Freelancer missed final deadline</option>
                <option value="incomplete_work">Freelancer submitted unfinished work</option>
                <option value="communication_issue">Communication breakdown</option>
                <option value="no_feedback">Freelancer is unresponsive</option>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Provide details about the work quality, deadlines, or communication issues..."
