      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Link to={'/about-us'} className="text-sm font-bold text-gray-500 hover:text-gray-700 text-justify" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                About Us
              </Link>
              <Link to={'/contact-us'} className="text-sm font-bold text-gray-500 hover:text-gray-700 text-justify" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Contact
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Link to={'/faq'} className="text-sm font-bold text-gray-500 hover:text-gray-700 text-justify" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                FAQs
              </Link>
              <Link to={'/support'} className="text-sm font-bold text-gray-500 hover:text-gray-700 text-justify" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                support
              </Link>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Link to={'/terms-and-conditions'}  className="text-sm font-bold text-gray-500 hover:text-gray-700 text-justify" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Terms and Conditions
              </Link>
              <Link to={'/privacy-policies'} className="text-sm font-bold text-gray-500 hover:text-gray-700 text-justify" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Privacy Policy
              </Link>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-gray-400 pt-6 md:flex-row">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.linkedin.com/in/navaneethsankar/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
