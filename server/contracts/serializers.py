...
from .models import Contract,ContractDeliverable 
...
class ContractSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'skills','profile_photo', 'package_name', 'delivery_days'
        ]
...
class ContractDeliverableSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if deliverable_type == 'file':
            ...
            try:
                ...
                # Force the use of the project-wide cloud name
    ...
    # Clean up temporary write-only fields
